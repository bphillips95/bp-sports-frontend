...
class ScoreBoard extends Component {
    ...
    handleRender = () => {
        ...
        {game.shortName}<br/> 
                {game.status.type.name === "STATUS_FINAL" ?  `${game.competitions[0].competitors[0].score} - ${game.competitions[0].competitors[1].score}` : null}
       <br/> {game.status.type.name === "STATUS_FINAL" ?  game.status.type.detail : game.date.slice(11,16)}
            </Menu.Item>
            )}
            </Menu>
            </div>
